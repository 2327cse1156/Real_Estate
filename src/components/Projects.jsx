...
const Projects = () => {
  ...
  return (
    <motion.div initial={{opacity:0,x:-200}} transition={{duration:1}} whileInView={{opacity:1,x:0}} viewport={{once:true}} className="mx-auto container py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden" id='Projects'>
      ...
      <div className='flex justify-end items-center mb-8'>
        <button className="p-3 bg-gray-200 rounded mr-2" aria-label='Previous Project' onClick={prevProject}>
          <img src={assets.left_arrow} alt='prev'></img>
        </button>
