      ...
      <div className="absolute top-0 left-0 w-full z-10">
        <div className="container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent">
            ...
            <ul className='hidden md:flex gap-7 text-white'>
                ...
                <a href='#Projects' className="cursor-pointer hover:text-gray-900">Projects</a>
                <a href='#Testimonials' className="cursor-pointer hover:text-gray-900">Testimonials</a>
            </ul>
            <button className="hidden md:block bg-white px-8 py-2 rounded-full">Sign up</button>
            <img onClick={()=> setShowMobileMenu(true)} src={assets.menu_icon}className='md:hidden w-7' alt=''></img>
        </div>
        {/* mobile menu */}
